...
plt.plot(filtered_indices, filtered_actual, color='blue', marker='o', linestyle='-', label='Actual Values')
plt.plot(filtered_indices, filtered_predicted, color='red', marker='x', linestyle='--', label='Predicted Values')
plt.xlabel('Index')
plt.ylabel('Value')
